              ...
              <div className="flex items-center justify-between mt-3">
                <div className="flex items-center gap-3">
                  <RiDeleteBin2Fill
                    ...
                    className="text-[#ababab] hover:text-red-500 transition-all cursor-pointer"
                    size={20}
                  />
                  <FaNotesMedical
                    className="text-[#ababab] hover:text-[#b33a3a] transition-all cursor-pointer"
                    size={20}
                  />
                </div>
                <p className="text-[#f5f5f5] text-md font-bold">S/ {item.price.toFixed(2)}</p>
              </div>
            </div>
          );
        })}
